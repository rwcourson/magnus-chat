...
export const staticGlobalCommands: GlobalCommand[] = [
  ...
  },
  {
    ...
    action: "navigate",
    href: "/skills",
    keywords: ["skills", "agents", "prompts"],
  },
  {
    id: "nav-routines",
    label: "Routines",
  ...
  },
  {
    ...
    action: "navigate",
    href: "/feed",
    keywords: ["news", "posts", "feed", "room", "bulletin", "live", "company room"],
  },
  {
    id: "nav-people",
    label: "People",
  ...
  },
  {
    ...
    action: "navigate",
    href: "/knowledge",
    keywords: ["docs", "browse", "policy", "search corpus"],
  },
  {
    id: "nav-apps",
    label: "Magnus apps",
    ...
    action: "navigate",
    href: "/apps",
    keywords: ["launcher", "skills", "tools", "waffle"],
  },
  {
    id: "nav-resources",
    ...
    action: "navigate",
    href: "/resources",
    keywords: ["benefits", "hr", "external", "intranet links"],
  },
  {
    id: "nav-integrations",
    label: "Integrations",
  ...
  },
  {
    id: "toggle-theme",
    label: "Toggle theme",
    description: "Cycle dark / Magnus / light",
    group: "System",
    icon: Moon,
    shortcut: "⌘.",
    action: "toggle-theme",
